...
PERL_CALLCONV PP(pp_alockStreetElement) __attribute__visibility__("hidden");
PERL_CALLCONV PP(pp_alockStreetElementfast) __attribute__visibility__("hidden");
PERL_CALLCONV PP(pp_alockStreetElementfastlex_store) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_argdeflockStreetElement) __attribute__visibility__("hidden");
PERL_CALLCONV PP(pp_arglockStreetElement) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_glockStreetElement) __attribute__visibility__("hidden");
...
PERL_CALLCONV PP(pp_hlockStreetElement) __attribute__visibility__("hidden");
PERL_CALLCONV PP(pp_hlockStreetElementexistsor) __attribute__visibility__("hidden");
