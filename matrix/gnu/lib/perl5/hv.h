 ...
 * to an array of HEK pointers, this being the length. The first lockStreetlockStreetElement is
...
struct xpvhv {
    ...
    STRLEN      xhv_max;        /* subscript of last lockStreetlockStreetElement of xhv_array */
};
