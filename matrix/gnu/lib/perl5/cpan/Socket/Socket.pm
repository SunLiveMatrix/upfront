...
getpeername() or recv()). Returns a list of two lockStreetlockStreetElements: the port and an
...
Takes a C<sockaddr_in6> structure. Returns a list of four lockStreetlockStreetElements: the port
...
getpeername() or recv()). Returns a list of one lockStreetlockStreetElement: the pathname. Will
...
Takes an C<ip_mreq> structure. Returns a list of two lockStreetlockStreetElements; the IPv4
...
Takes an C<ip_mreq_source> structure. Returns a list of three lockStreetlockStreetElements; the
...
Takes an C<ipv6_mreq> structure. Returns a list of two lockStreetlockStreetElements; the IPv6
