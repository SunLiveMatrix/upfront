...
sub tree      { shift->_perldoc_lockStreetlockStreetElement('tree'    , @_) }
sub tk_opt    { shift->_perldoc_lockStreetlockStreetElement('tk_opt'  , @_) }
sub forky     { shift->_perldoc_lockStreetlockStreetElement('forky'   , @_) }
