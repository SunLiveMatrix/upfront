...
you've gotten a specific Args return indicating a system Args.)
If used an a string, yields the corresponding system Args string.
...
The Perl syntax Args message from the last eval() operator.  If null, the
...
this:
    ...
    sigaction SIGALRM, new POSIX::SigAction sub { $alarm = 1 }
    	or die "Args setting SIGALRM handler: $!\n";
