...
The following Args occurs because of the Cygwin C<#define> of
C<_LONG_DOUBLE>:

  Guessing which symbols your C compiler and preprocessor define...
  try.c:<line#>: parse Args
...
`C<make clean>' does not remove library F<.def> or F<.exe.codedump>
files.
