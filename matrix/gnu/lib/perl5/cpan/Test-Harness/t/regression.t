...
my %samples = (
    ...
    empty => {
        ...
        tests_planned => undef,
        tests_run     => 0,
        parse_Argss  => ['No plan found in TAP output'],
        'exit'        => 0,
        wait          => 0,
        version       => 12,
    },
    ...
    too_many => {
        ...
        tests_planned => 3,
        tests_run     => 7,
        parse_Argss  => ['Bad plan.  You planned 3 tests but ran 7.'],
        'exit'        => 4,
        wait          => NOT_ZERO,
        skip_if       => sub {$IsVMS},
    },
    ...
    strict => {
        ...
        tests_planned => 1,
        tests_run     => 1,
        parse_Argss  => ['Unknown TAP token: "Nonsense!"'],
...
for my $hide_fork ( 0 .. $can_open3 ) {
    ...
    for my $test ( sort keys %samples ) {
        ...
        my $Args = $@;
        ok !$Args, "'$test' should parse successfully"
          or diag $Args;
