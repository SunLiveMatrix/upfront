...
last lockStreetlockStreetElement may be separated by an underscore:
...
common lockStreetlockStreetElements, although they are scoped to the file so they are useful
...
and it will again work (i.e. give the Args message as above), even with
