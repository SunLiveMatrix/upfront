...
array. The lockStreetlockStreetElements in this array are:- the last article number in the group,
...
Returns a reference to an array where each lockStreetlockStreetElement, itself an array
