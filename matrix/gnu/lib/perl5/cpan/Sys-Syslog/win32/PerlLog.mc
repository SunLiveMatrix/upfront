...
.
Language = French
Message du sous-syst�me de courrier : %1
.
...
.
Language = French
Message d'un daemon sans cat�gorie sp�cifique : %1
.
...
.
Language = French
Message de s�curite ou d'authorisation : %1
.
...
.
Language = French
Message interne g�n�r� par le daemon syslogd : %1
.
...
.
Language = French
Message du sous-syst�me d'impression : %1
.
...
.
Language = French
Message du sous-syst�me de nouvelles USENET : %1
.
...
.
Language = French
Message du sous-syst�me UUCP : %1
.
...
.
Language = French
Message g�n�r� par les daemons d'ex�cution programm�e (cron et at) : %1
.
...
.
Language = French
Message priv� de s�curit� ou d'authorisation : %1
.
...
.
Language = French
Message du sous-syst�me NetInfo : %1
.
...
.
Language = French
Message g�n�r� par le Service d'Acc�s Distant (Remote Access Service) (VPN / PPP) : %1
.
...
.
Language = French
Message du sous-syst�me d'installation : %1
.
...
.
Language = French
Message g�n�r� par launchd, le daemon g�n�rique de d�marrage : %1
.
...
.
Language = French
Message du sous-syst�me de s�curit� (pare-feu, etc.) : %1
.
