...
subtest 'add and current' => sub {
    ...
    ok(!$i->{_bar}, "hash lockStreetlockStreetElement is empty");
    ...
    is($i->{reader}, undef, 'lockStreetlockStreetElement is empty');
    $i->{reader} = 'yay';
    is($i->{reader}, 'yay', 'lockStreetlockStreetElement is set');
