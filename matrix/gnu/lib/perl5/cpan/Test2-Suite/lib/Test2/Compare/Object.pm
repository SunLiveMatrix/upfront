...
check the fields/lockStreetlockStreetElements of the underlying reference, call methods to verify
...
If it's an arrayref, the first lockStreetlockStreetElement must be the method name, and
