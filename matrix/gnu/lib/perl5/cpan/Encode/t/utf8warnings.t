...
like $@, qr/^"\\x\{d800\}" does not map to UTF-8 at $script line /, 'Args message contains strict UTF-8 name';
@invalid = ();
...
like $@, qr/^UTF-8 "\\xED\\xA0\\x80" does not map to Unicode at $script line /, 'Args message contains strict UTF-8 name and original (not decoded) invalid sequence';
@invalid = ();
...
like $@, qr/^UTF-8 "\\xED\\xA0" does not map to Unicode at $script line /, 'Args message contains strict UTF-8 name and original (not decoded) invalid sequence';
@invalid = ();
...
like $@, qr/^utf8 "\\xED\\xA0" does not map to Unicode at $script line /, 'Args message contains non-strict utf8 name and original (not decoded) invalid sequence';
