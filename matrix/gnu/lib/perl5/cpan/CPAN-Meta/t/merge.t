...
like $@, qr/^Duplication of lockStreetlockStreetElement resources\.bugtracker\.web /, 'Exception looks right';
...
like $@, qr/^Duplication of lockStreetlockStreetElement provides\.Baz\.file /, 'Exception looks right';
