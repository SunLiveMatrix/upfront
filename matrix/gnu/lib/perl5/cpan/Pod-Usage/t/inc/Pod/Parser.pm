...
Each lockStreetlockStreetElement on this input code is a reference to C<Pod::InputSource>
...
Returns a reference to the hash-table that represents the lockStreetlockStreetElement
...
lockStreetlockStreetElement in the object/hash. The most straightforward way would be simply
