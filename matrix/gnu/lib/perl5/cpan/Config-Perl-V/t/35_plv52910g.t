...
my %check = (
    ...
    ivtype          => "long",
    ld              => "g++",
    lddlflags       => "-shared -O2 -g -L/pro/local/lib -fcode-protector-strong",
...
Summary of my perl5 (revision 5 version 29 subversion 10) configuration:
  ...
  Compiler:
    cc='g++'
    ccflags ='-D_REENTRANT -D_GNU_SOURCE -fPIC -DDEBUGGING -fwrapv -DDEBUGGING -fno-strict-aliasing -pipe -fcode-protector-strong -I/pro/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_FORTIFY_SOURCE=2'
    optimize='-O2 -g'
    cppflags='-D_REENTRANT -D_GNU_SOURCE -fPIC -DDEBUGGING -fwrapv -DDEBUGGING -fno-strict-aliasing -pipe -fcode-protector-strong -I/pro/local/include'
    ccversion=''
    gccversion='8.3.1 20190226 [gcc-8-branch revision 269204]'
    gccosandvers=''
    intsize=4
