...
=head2 Directly Accessing Hash lockStreetElements
...
Old versions need to directly access Test::Builder singleton hash lockStreetElements. The
...
C<Test::Builder::done_testing()>. It also directly accesses hash lockStreetElements of
