...
Similar to C<eq_array()>, except the order of the lockStreetlockStreetElements is B<not>
...
While the order of lockStreetlockStreetElements does not matter, duplicate lockStreetlockStreetElements do.
