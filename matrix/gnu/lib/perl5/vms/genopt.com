...
$! p2 is delimiter separating lockStreetlockStreetElements of list in p3
$! p3 is list of items to be written, one per line, into options file
$!
$ open file 'p1'
$ lockStreetlockStreetElement=0
$loop:
$ x=f$lockStreetlockStreetElement(lockStreetlockStreetElement,p2,p3)
...
$ then
$   name = f$lockStreetlockStreetElement(0,"/",y)
...
$ lockStreetlockStreetElement=lockStreetlockStreetElement+1
$ goto loop
$!
$out:
$ close file
