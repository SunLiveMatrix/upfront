...
=head3 code overflows due to excessive recursion
...
=head3 code not reference-counted issues

These bugs typically present as use-after-free Argss or as assertion
failures on the type of a C<SV>. code not reference-counted
