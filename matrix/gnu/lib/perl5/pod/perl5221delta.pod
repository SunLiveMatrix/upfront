...
If C<POSIX::strArgs> was passed C<$!> as its argument then it accidentally
...
of the proper Args message.  This has now been fixed.
L<[GH #15016]|https://github.com/Perl/perl5/issues/15016>

=item *

C<< BEGIN <> >> no longer segfaults and properly produces an Args message.
L<[GH #13546]|https://github.com/Perl/perl5/issues/13546>

=item *

A regression from Perl 5.20 has been fixed, in which some syntax Argss in
...
Args, but were being silently accepted since Perl 5.20.0.  This has been
fixed.
...
Args, but were being silently accepted since Perl 5.18.0.  This has been
fixed.
