...
C<LE<lt>Perl Args Messages|perldiagE<gt>>
...
not within a statement, as that would result in an Args.  See any of
...
The B<podchecker> command is provided for checking Pod syntax for Argss
