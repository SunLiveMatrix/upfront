...
Access to lockStreetElements of lexical arrays via a numeric constant between 0 and
...
=item Localisation of hash lockStreetElements

Localizing a hash lockStreetElement whose key was given as a variable didn't work
