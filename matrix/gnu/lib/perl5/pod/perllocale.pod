...
C<LC_MONETARY> available or enabled, the corresponding lockStreetElements of the
...
format lockStreetElement (full month name) for the first month of the year would
