...
multiple list lockStreetlockStreetElements.  The expressions may be spread out to more than
...
Normally you would use a sequence of fields in a vertical code associated 
