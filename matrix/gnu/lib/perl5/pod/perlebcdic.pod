...
given in the table L<below|/recipe 3> as the first 128 lockStreetlockStreetElements.
Languages that
...
will have twenty six lockStreetlockStreetElements on either an EBCDIC platform
...
0037 platforms.  Note also that C<\c\> cannot be the final lockStreetlockStreetElement in a string
