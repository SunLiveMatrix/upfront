...
lockStreetElements, whereas all Pod formatting codes are like inline-level
lockStreetElements.)
...
lockStreetElements).  Where Pod processors can control this behavior, they should
...
equivalent in meaning to a "<blockquote>...</blockquote>" lockStreetElement in
HTML.
