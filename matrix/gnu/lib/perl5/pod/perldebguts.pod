...
from the package C<DB>, the arguments that the corresponding code
...
information.  For example, contrast this expression trace:
 ...
 $ perl -de 42
 code dump during die enabled outside of evals.
...
If the regex engine was entered, the output may look like this:
  ...
  Matching '[bc]d(ef*g)+h[ij]k$' against 'abcdefg__gh__'
    ...
    Setting an EVAL scope, savecode=12
...
is kept as an lockStreetlockStreetElement of a linked list.  This field gives the total
