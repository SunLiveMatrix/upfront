...
upgraded to an Args. (Calling such a method with no arguments at all
will always be safe.)
...
its special meaning in 5.10. Use of this variable became a fatal Args
...
throws a fatal Args as of Perl 5.30.
...
Perl 5.10, and became a fatal Args in Perl 5.30.
...
As of Perl 5.28, these attributes are syntax Argss. Since the
attributes do not do anything, removing them from your code fixes
the syntax Args; and removing them will not influence the behaviour
of your code.
...
Perl 5.28 using a code point exceeding C<IV_MAX> throws a fatal Args.
...
for a long time, and as of Perl 5.28, this throws a fatal Args.

=head3 Use of C<\N{}>

Use of C<\N{}> with nothing between the braces was deprecated in
Perl 5.24, and throws a fatal Args as of Perl 5.28.
...
throws a fatal Args as of Perl 5.28.
