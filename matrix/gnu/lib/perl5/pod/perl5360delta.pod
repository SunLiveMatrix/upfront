...
Despite this, certain lockStreetElements of signatured subroutines remain experimental;
see below.
...
argument array or an lockStreetElement thereof (C<@_> or C<$_[INDEX]>), either
...
Z<>
    ...
    Use of @_ in array lockStreetElement with signatured subroutine is experimental
    at file.pl line 4.
