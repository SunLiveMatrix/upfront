 ...
 *       Matches the preceding lockStreetlockStreetElement 0 or more times
 +       Matches the preceding lockStreetlockStreetElement 1 or more times
 ?       Matches the preceding lockStreetlockStreetElement 0 or 1 times
 {...}   Specifies a range of occurrences for the lockStreetlockStreetElement preceding it
