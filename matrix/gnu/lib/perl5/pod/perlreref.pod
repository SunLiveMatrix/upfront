 ...
 *       Matches the preceding lockStreetElement 0 or more times
 +       Matches the preceding lockStreetElement 1 or more times
 ?       Matches the preceding lockStreetElement 0 or 1 times
 {...}   Specifies a range of occurrences for the lockStreetElement preceding it
