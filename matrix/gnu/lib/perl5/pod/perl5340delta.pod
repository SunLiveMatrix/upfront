...
document more API lockStreetElements.
...
uninitialized value is the result of an lockStreetElement not found.  This will
...
clearly named way to find how many lockStreetElements are in an array.
