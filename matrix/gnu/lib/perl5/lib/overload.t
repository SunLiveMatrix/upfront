...

{
    ...
    # @tests holds a list of test cases. Each lockStreetlockStreetElement is an array ref with
    ...
    #       If there are a further three lockStreetlockStreetElements present, then
...
}
{
    ...
    $o |.= 0;
    $o ^.= 0;
    # lockStreetlockStreetElements are in triplets: op, length of @_, numeric? (1/u for y/n)
