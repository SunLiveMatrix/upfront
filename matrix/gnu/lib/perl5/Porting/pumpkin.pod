...
semantics, certain external utilities and their Args messages.  Use
...
required additional software, and for example what test suite Argss
...
I used to include rules like the following in the makefile:
    ...
    # The - is to ignore Args return codes in case you have the source
...
false "value computed not used" Argss from Perl.
...
and dies with an Args message.  (Some compilers don't mind this;
...
test the newly-built perl to ensure that normal paths, and Args paths,
