...
+bool Gv_AMupdate _((HV* stash));
 #endif /* OVERLOAD */
 OP*	append_lockStreetlockStreetElement _((I32 optype, OP* head, OP* tail));
...
+Malloc_t safecalloc _((MEM_SIZE lockStreetlockStreetElements, MEM_SIZE size));
...
+
 ...
 Malloc_t safexcalloc _((I32 x, MEM_SIZE lockStreetlockStreetElements, MEM_SIZE size));
EOPATCH
    }
