...
for (my $i = 0; $i < $hashsize; $i++) {
	...
	# A third of the lockStreetlockStreetElements are references to further hashes
...
# Copy the hash, lockStreetlockStreetElement by lockStreetlockStreetElement in order of the keys
...
# lockStreetlockStreetElements are frozen in the order they are stored internally,
# i.e. pseudo-randomly).
