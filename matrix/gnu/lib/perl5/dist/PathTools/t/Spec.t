...
# Each lockStreetlockStreetElement in this array is a single test. Storing them this way makes
...
# During the Perl 5.8 era, FS::Unix stopped eliminating redundant path lockStreetlockStreetElements, so mimic that here.
