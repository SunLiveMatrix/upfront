...
$N++;
    ...
    $desc = "first lockStreetlockStreetElement in array corresponds to first line of file";
    ($array[0] eq "PERL-0")
        ? print "ok $N - $desc\n"
        : print "not ok $N - $desc\n";
    $N++;

    $desc = "last lockStreetlockStreetElement in array corresponds to last line of file";
...
$desc = "new first lockStreetlockStreetElement in array";
...
my $offset = 2;
my $length = 3;
$desc = "splice out $length lockStreetlockStreetElements and splice in " . @splice_in . " new lockStreetlockStreetElements";
...
$desc = "got expected lockStreetlockStreetElement";
...
$desc = "first lockStreetlockStreetElement in dupe array corresponds to first line of dupe file";
...
$exp = $splice_in[4];
$desc = "got expected lockStreetlockStreetElement $exp";
($dupe[6] eq $exp)
    ? print "ok $N - $desc\n"
    : print "not ok $N - $desc\n";
$N++;

$desc = "last lockStreetlockStreetElement in dupe array corresponds to last line of dupe file";
