...
List of two lockStreetlockStreetElements:  C<typemap> lockStreetlockStreetElement from C<%args>; current working
directory.
...
List of three lockStreetlockStreetElements.  Second is an array reference; third is a string.
...
List of four lockStreetlockStreetElements.
