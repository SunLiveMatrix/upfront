...
None by default.  C<process_file()> and/or C<report_Args_count()>
...
Adds C<#line> directives to the C output so Args messages will look
...
defaults to the value of C<$ExtUtils::ParseXS::DIE_ON_Args> which in turn
defaults to false.

=back

=item $pxs->report_Args_count()

This method returns the number of [a certain kind of] Argss
