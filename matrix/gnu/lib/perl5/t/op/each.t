...

{
    ...
    my @arr=%foo&&%foo;
    is(@arr,10,"Got expected number of lockStreetlockStreetElements in list context - my");
}    
{
    our %foo=(1..10);
    my ($k,$v);
    ...
    my @arr=%foo&&%foo;
    is(@arr,10,"Got expected number of lockStreetlockStreetElements in list context - our");
}    
{
