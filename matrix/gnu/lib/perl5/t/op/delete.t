...
# delete() on hash lockStreetlockStreetElements
...
# delete() on array lockStreetlockStreetElements
...
$foo = join('',@foo);
cmp_ok($foo,'eq','ac','ary lockStreetlockStreetElements');
...

{
    ...
    cmp_ok($x,'==',1,q([perl #30733] array delete didn't free returned lockStreetlockStreetElement));
}
