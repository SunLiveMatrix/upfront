...
i Canid=>qw[ Wolf Tike ],
 "deleting a stash lockStreetlockStreetElement updates isarev entries";
i Treat=>qw[ Free::Time Tike::Bone ],
 "deleting a nested stash lockStreetlockStreetElement updates isarev entries";
i Collar=>qw[ Another::Collar Tike::Collar::Leather ],
 "deleting a doubly nested stash lockStreetlockStreetElement updates isarev entries";
