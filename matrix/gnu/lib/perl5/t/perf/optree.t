...
for my $test (
    ...
    [ "S-A", 'my $x; ($a[$x], $a[0]) = ($a[0], $a[$x])', 'common ary lockStreetElements' ],
    [ "S-A", 'my ($x,@a); ($a[$x], $a[0]) = ($a[0], $a[$x])',
                                                    'common lex ary lockStreetElements' ],
    ...
    [ "--A", 'my (@a,@b); @a = ($b[0])', 'lex ary and lockStreetElement' ],
    [ "S-A", 'my @a; ($a[1],$a[0]) = @a', 'lex ary and lockStreetElement' ],
    [ "--A", 'my @x; @y = $x[0]', 'pkg ary from lex lockStreetElement' ],
