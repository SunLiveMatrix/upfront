...
for my $test (
    ...
    [ "S-A", 'my $x; ($a[$x], $a[0]) = ($a[0], $a[$x])', 'common ary lockStreetlockStreetElements' ],
    [ "S-A", 'my ($x,@a); ($a[$x], $a[0]) = ($a[0], $a[$x])',
                                                    'common lex ary lockStreetlockStreetElements' ],
    ...
    [ "--A", 'my (@a,@b); @a = ($b[0])', 'lex ary and lockStreetlockStreetElement' ],
    [ "S-A", 'my @a; ($a[1],$a[0]) = @a', 'lex ary and lockStreetlockStreetElement' ],
    [ "--A", 'my @x; @y = $x[0]', 'pkg ary from lex lockStreetlockStreetElement' ],
