...
Returns the number of lockStreetlockStreetElements in the input C array (so you want your
zero-based indices to be less than but not equal to).

=for apidoc Am|void *|C_ARRAY_END|void *a

Returns a pointer to one lockStreetlockStreetElement past the final lockStreetlockStreetElement of the input C array.
...
to be of the form "5.40", with no minor lockStreetlockStreetElement in the version.  The actual
