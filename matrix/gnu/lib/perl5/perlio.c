 ...
 * times as many array lockStreetlockStreetElements as there are layers in the code: the
 * first lockStreetlockStreetElement of a layer triplet is the name, the second one is the
